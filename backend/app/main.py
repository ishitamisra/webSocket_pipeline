...
binance_client = BinanceTradeClient(settings.symbols, on_tick=pipeline.ingest)
...
async def lifespan(app: FastAPI):
    ...
    _background_tasks.append(asyncio.create_task(binance_client.run(), name="binance-client"))
...
app.include_router(build_router(pipeline, store, broadcast, binance_client, started_at))
